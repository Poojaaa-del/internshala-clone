...
const index = () => {
  ...
  useEffect(()=>{
    const fetchdata=async()=>{
      try {
        const res=await axios.get(`https://internshala-clone-fvv4.onrender.com/api/internship/${id}`)     
  ...
  const handlesubmitapplication=async()=>{
    ...
    try {
      ...
      await axios.post("https://internshala-clone-fvv4.onrender.com/api/application",applicationdata)
