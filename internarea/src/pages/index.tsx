...
import thirdsilde from "@/assets/thirdsilde.webp";
    ...
    const fetchdata = async () => {
      try {
        const [internshipres, jobres] = await Promise.all([
          axios.get("https://internshala-clone-fvv4.onrender.com/api/internship"),
          axios.get("https://internshala-clone-fvv4.onrender.com/api/job"),
        ]);
